        ...
        <div class="aiChat">
            ...
            <div class="chatHeader">
                <div class="chatAvatar">
                    <img src="../../../public/img/hkylogo.webp" />
                </div>
                <div class="chatTitle">
                ...
                <div style="padding-top: 0px; padding-bottom: 0px">
                    ...
                    <div class="indexBubble">
                        ...
                        <div class="BubbleConten BubbleContentLeft">
                            <p>
                                你好，我是河科院图书管理系统AI机器人小智，请问有什么可以帮到您？
                            </p>
                        </div>
                    </div>
                    <ul class="questionList">
                        <li class="questionListItem" v-for="(item, index) in requestObj.initialProblem" :key="index"
                            :style="{ background: item.bgColor }" @click="setSubmit(item.text)">
                            {{ item.text }}
                        </li>
                    </ul>
                    <div class="indexBubble" v-for="(item, index) in chatList_client" :key="index">
            ...
            <div class="chatInupt">
                <div class="chatTextarea">
                    <div class="chatTextareaInput">
                        <textarea rows="1" placeholder="请输入您要问的内容，如:“小组的学习模式”" v-model="question"
                            @keydown.enter="setSubmit(question)" class=""></textarea>
                    </div>
...
export default {
    ...
    methods: {
        ...
        setSubmit(questionText) {
            questionText = questionText.trim()
            if (questionText) {
                if (questionText) this.fetchAnswer(questionText)
                this.chatList_client.push({
                    role: "user",
        ...
        scrollToBottom() {
            if (this.$refs.chatContainer) {
                this.$refs.chatContainer.scrollTop = this.$refs.chatContainer.scrollHeight + 80;
            }
        },
        outing() {
